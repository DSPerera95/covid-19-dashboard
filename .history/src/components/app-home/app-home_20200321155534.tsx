  ...
  render() {
    if (this.situationData !== null) {
      return (
        <div class='app-home'>
          <div class="wrapper">
            <div class="row" style = {{paddingLeft: '20px', justifyContent: 'center'}}>
              ...
              <div class="col-md-3">
                <div class="card">
                  <div class="card-body">
                      ...
                      <p class="card-text">{this.situationData.data.local_new_cases}</p>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                <div class="card">
                  <div class="card-body">
                      ...
                      <p class="card-text">{this.situationData.data.local_recovered}</p>
                  </div>
                </div>
              </div>
            </div>
